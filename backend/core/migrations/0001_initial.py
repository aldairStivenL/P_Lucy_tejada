    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('admin', 'Administrador'), ('formador', 'Formador'), ('estudiante', 'Estudiante')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('formador', models.ForeignKey(limit_choices_to={'rol': 'formador'}, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Inscripcion',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('asistencia', models.JSONField(default=list)),
